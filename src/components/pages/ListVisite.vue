    ...
    <div id="app-content">
      ...
      <div class="app-content-area">
        ...
        <div class="container-fluid mt-n22">
          <h2 style="color: #41160a">Liste des visites </h2>
          <br />
          <div class="row">
            <div class="col-4">
                      ...
                      <table class="table text-nowrap mb-0 table-centered table-hover">
                        <thead style="background-color: #41160a;">
                          <tr>
                            ...
                            <th style="color: white"> Heure Eng </th>

                            <th style="color: white"> Gérant </th>

                            <th style="color: white">Tel du gerant </th>
                        ...
                        <tbody>
                          <tr v-for="(data, i) in listes.tabListappro" :key="i">
                            ...
                            <td><span class="badge badge-primary-soft"> {{ data.sTelGerant }}
                              </span></td>
                            ...
                            <td>
                              ...
                              <router-link to="maps" target="_blank">
