      ...
      <div class="h-100" data-simplebar>
        ...
        <span class="navbar-brand">
          <router-link to="dashboard">
            <img src="../assets/logo3.png" alt="dash ui - bootstrap 5 admin dashboard template" />
          </router-link>
        </span>
        <!-- Navbar nav -->
        <ul class="navbar-nav flex-column" id="sideNavbar">
          <!-- <li class="nav-item">
            <a class="nav-link has-arrow collapsed" href="#!" data-bs-toggle="collapse" data-bs-target="#navecommerce"
              ...
              <Icon class="nav-icon me-2 icon-xxs" type="ios-keypad" />
            ...
            <div id="navecommerce" class="collapse" data-bs-parent="#sideNavbar">
              <ul class="nav flex-column">
                <li class="nav-item" style="padding-left: 30px">
                  <router-link class="nav-link has-arrow" to="caissieres">
                    Caissières
                  </router-link>
                </li>

                <li class="nav-item" style="padding-left: 30px">
                  <router-link class="nav-link has-arrow" to="serveuses">
                    Serveuses
                  </router-link>
                </li>
              </ul>
          ...
          <!-- <li class="nav-item">
            <a class="nav-link has-arrow collapsed" href="#!" data-bs-toggle="collapse" data-bs-target="#navecommerce2"
              aria-expanded="false" aria-controls="navecommerce">
              <Icon class="nav-icon me-2 icon-xxs" type="ios-keypad" />
              Gestions des caisses
            </a>

            <div id="navecommerce2" class="collapse" data-bs-parent="#sideNavbar">
              <ul class="nav flex-column">
                <li class="nav-item" style="padding-left: 30px">
                  <router-link class="nav-link has-arrow" to="categories">
                    Catégories
                  </router-link>
                </li>
                <li class="nav-item" style="padding-left: 30px">
                  <router-link class="nav-link has-arrow" to="caisses">
                    Caisses
                  </router-link>
                </li>
              </ul>
          ...
          <li class="nav-item">
            <router-link to="listvente" class="nav-link has-arrow">
              <Icon class="nav-icon me-2 icon-xxs" type="ios-keypad" /> Ventes
            </router-link>
          </li>

          <li class="nav-item">
            <router-link to="listvisite" class="nav-link has-arrow">
              <Icon class="nav-icon me-2 icon-xxs" type="ios-keypad" /> Visites
            </router-link>
          </li>

          <li class="nav-item">
            <router-link to="produits" class="nav-link has-arrow">
              <Icon class="nav-icon me-2 icon-xxs" type="ios-keypad" /> Produits
            </router-link>
          </li>


          <li class="nav-item">
            <router-link to="listplanning" class="nav-link has-arrow">
              <Icon class="nav-icon me-2 icon-xxs" type="ios-keypad" /> Planning
            </router-link>
          </li>

          <li class="nav-item">
            <router-link to="listdevice" class="nav-link has-arrow">
              <Icon class="nav-icon me-2 icon-xxs" type="ios-keypad" /> Devices
            </router-link>
          </li>

          <li class="nav-item">
            <router-link to="pdv" class="nav-link has-arrow">
              <Icon class="nav-icon me-2 icon-xxs" type="ios-keypad" /> PDV
            </router-link>
          </li>
          ...
          <li class="nav-item">
            ...
            >
              <i data-feather="edit" class="nav-icon me-2 icon-xxs"> </i> Blog
            </a>
          ...
          <li class="nav-item">
            ...
            <div id="navLayouts" class="collapse" data-bs-parent="#sideNavbar">
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="horizontal/index.html">
                    Horizontal</a
                  >
                </li>
              </ul>
          ...
          <li class="nav-item">
            ...
            <div id="navDocs" class="collapse" data-bs-parent="#sideNavbar">
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a href="docs/index.html" class="nav-link">Introduction</a>
                </li>
                <li class="nav-item">
                  <a href="docs/environment-setup.html" class="nav-link"
                    >Environment setup</a
                  >
                </li>
                <li class="nav-item">
                  <a href="docs/working-with-gulp.html" class="nav-link"
                    >Working with Gulp</a
                  >
                </li>
                <li class="nav-item">
                  <a href="docs/compiled-files.html" class="nav-link"
                    >Compiled Files</a
                  >
                </li>
                <li class="nav-item">
                  <a href="docs/file-structure.html" class="nav-link"
                    >File Structure</a
                  >
                </li>
                <li class="nav-item">
                  <a href="docs/resources-assets.html" class="nav-link"
                    >Resources & assets</a
                  >
                </li>
                <li class="nav-item">
